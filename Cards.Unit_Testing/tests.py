...
class TestCard(unittest.TestCase):
    ...
    def test_q3(self):
        ...
        self.assertEqual(hw5_cards.Card.__str__(q3), 'King of Spades')

        return hw5_cards.Card.__str__(q3), "King of Spades"
    ...
    def test_q7(self):
        ...
        before = len(q7.cards)
        q7_1 = q7.deal_card()
        q7.replace_card(q7_1)
        self.assertEqual(len(q7.cards),before, 52)

        return len(q7.cards),before, 52
    ...
    def test_q8(self):
        ...
        for c in q8.cards:
            q8.replace_card(c)
            self.assertEqual(len(q8.cards),before)

        return len(q8.cards),before
